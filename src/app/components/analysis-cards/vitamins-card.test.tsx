...
import VitaminsCard from './vitamins-card';
...
describe('vitamins card', () => {
    ...
    it('should render card with CircleRow for small screen', () => {
        ...
        expect(CircleRow).toHaveBeenCalledTimes(13);
    });
    ...
    it('should render card with BarColumns for large screen', () => {
        ...
        expect(BarColumn).toHaveBeenCalledTimes(13);
    });
})